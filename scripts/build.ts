...
result = await Bun.build({
  ...
  define: {
    ...
    'MACRO.ISSUES_EXPLAINER':
      JSON.stringify('report the issue at https://github.com/SuryanshuNabheet/openclaude/issues'),
    'MACRO.FEEDBACK_CHANNEL':
      JSON.stringify('https://github.com/SuryanshuNabheet/openclaude/issues'),
    'MACRO.PACKAGE_URL': JSON.stringify('openclaude'),
